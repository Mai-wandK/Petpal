...
Petsitter.create!(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, email: Faker::Internet.email, phone_number: Faker::PhoneNumber.phone_number, description: "Need a petsitter who genuinely loves animals? Look no further! I'm here to make sure your dogs and cats not only get the care they need but also enjoy some quality playtime and affection.", photo:"2.png")

Petsitter.create!(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, email: Faker::Internet.email, phone_number: Faker::PhoneNumber.phone_number, description: "Hey, pet parents! I totally get that each pet is unique, so I offer personalized petsitting. Your dogs will get their walks, and your cats will get the love and attention they deserve.", photo:"3.png")

Petsitter.create!(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, email: Faker::Internet.email, phone_number: Faker::PhoneNumber.phone_number, description: "Your pets are family, and I treat them as such! With a focus on both dogs and cats, I provide a reliable and caring environment, ensuring your furry friends feel right at home.", photo:"4.png")

Petsitter.create!(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, email: Faker::Internet.email, phone_number: Faker::PhoneNumber.phone_number, description: "Furry companions are my specialty! Whether your pets bark or purr, my petsitting services are all about making sure your cat or dog are happy, healthy, and content while you're away.", photo:"5.png")
...
Petsitter.create!(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, email: Faker::Internet.email, phone_number: Faker::PhoneNumber.phone_number, description: "Experienced petsitter alert! I'm all about managing the diverse needs of your furry friends. From energetic playtime with your dogs to quiet moments with your cats, I've got your back!", photo:"10.png")
